            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="glyphicon glyphicon-user "></i><a href="{{route('user.index')}}">Tất Cả Tài Khoản</a></li>
                            <li><i class="glyphicon glyphicon-user "></i><a href="tables-data.html">Phân Quyền</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Quản lý Bình Luận</a>
                        <ul class="sub-menu children dropdown-menu">
